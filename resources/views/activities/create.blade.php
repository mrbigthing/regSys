    ...
    <div class="col-md-10 col-md-offset-1">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <form action="{{ URL('activities/activity') }}" method="POST">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
            <label for="title">标题</label>
            <input type="text" name="title" name="title" class="form-control" required="required">
            <br>
            <label for="content">内容</label>
            <textarea name="content" rows="10" class="form-control"></textarea>
            <br>
              <label for="visacontent">签证内容</label>
              <textarea name="visacontent" rows="10" class="form-control"></textarea>
              <br>
            <label for="start_register_time">开始时间</label>
            <input type="text" name="start_register_time" id="start_register_time" class="form-control" required="required">
            <br>
            <label for="end_register_time">结束时间</label>
            <input type="text" name="end_register_time" id="end_register_time" class="form-control" required="required">
            <br>
            <label for="end_register_time">最大人数</label>
            <input type="text" name="number" class="form-control">
            <br>
            <div style="text-align:center">
              <button class="btn btn-lg btn-info">创建</button>
            </div>
          </form>
