			...
			<div class="panel panel-default">
				...
				@if ( Auth::user()->is_admin < 2 )
					<div style="text-align:center; margin-bottom:10px;">
						<a href="{{ URL('registration/activity/'.$activity_id.'/confirm') }}" class="positive ui button">确定</a>
						<a href="{{ URL('registration/activity/'.$activity_id.'/edit_profile') }}" class="negative ui button">编辑</a>
					</div>
				@endif
			</div>
		</div>
